...
define( 'GENERATE_VERSION', '1.3.11');
...
function generate_widgets_init() {
	register_sidebar( array(
		...
		'after_widget'  => '</aside>',
		'before_title'  => apply_filters( 'generate_start_widget_title', '<n4 class="widget-title">' ),
		'after_title'   => apply_filters( 'generate_end_widget_title', '</n4>' ),
	) );
	register_sidebar( array(
