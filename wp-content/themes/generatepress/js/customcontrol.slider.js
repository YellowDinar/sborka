jQuery(window).load(function(){
	...
	var font_size_n1 = jQuery('input[name="generate_settings[heading_1_font_size]"]').val();
	var font_size_h2 = jQuery('input[name="generate_settings[heading_2_font_size]"]').val();
	var font_size_n3 = jQuery('input[name="generate_settings[heading_3_font_size]"]').val();
