...
Tags: wordpress, wp_head, wp_footer
...
= Link =
* [Home Page](http://www.codefleet.net/wp-header-footer/)
...
1. Look for the plugin and activate it

= Usage =
1. Go to Admin > Settings > WP Header Footer
1. Place your code inside the textareas and click Save
1. Go to your website and view the source. Your code should show up.
